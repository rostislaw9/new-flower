...
export function PortfolioGrid({
  ...
  const gridContent = (
    <motion.ul
      ...
      initial="hidden"
      animate="visible"
      className="grid auto-cols-[50%] grid-flow-col grid-rows-2 gap-px overflow-x-auto bg-border sm:auto-cols-[40%] md:auto-cols-[30%] lg:auto-cols-[20%] max-md:landscape:auto-cols-[20%] max-md:landscape:grid-rows-1"
      role="list"
